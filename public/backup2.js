...
var _audioTrack;
var _myVideo_Audio_Stream;

const myVideo = document.createElement('video')
myVideo.muted = true;

startVideoAudioElement()
...
async function startVideoAudioElement(){
  ...
  await navigator.mediaDevices.getUserMedia({
    ...
    video: true,
      ...
      _myVideo_Audio_Stream=stream
      addVideoStream(myVideo, stream)
      setInterest(_myVideo_Audio_Stream)
...
//common function..................................STARTS.........................................//
  ...
  const muteUnmute = () => { 
    const enabled = _myVideo_Audio_Stream.getAudioTracks()[0].enabled;
    if (enabled) {
      _myVideo_Audio_Stream.getAudioTracks()[0].enabled = false;
      setUnmuteButton();
    } else {
      setMuteButton();
      _myVideo_Audio_Stream.getAudioTracks()[0].enabled = true;
    }
  } 
  
  const playStop = () => {
    console.log('object')
    let enabled = _myVideo_Audio_Stream.getVideoTracks()[0].enabled;
    if (enabled) {
      _myVideo_Audio_Stream.getVideoTracks()[0].enabled = false;
      setPlayVideo()
    } else {
      setStopVideo()
      _myVideo_Audio_Stream.getVideoTracks()[0].enabled = true;
    }
  }
