...
function getHTMLMediaElement(mediaElement, config) {
    ...
    if (buttons.has('mute-audio')) {
        ...
        muteAudio.setAttribute('style', 'position: absolute;color:white;font-size:21px;text-shadow: 1px 1px black;padding:0;margin:0;text-align: left; margin-top: 260px; margin-left: -450px; display: block; border: 0;line-height:1.5;z-index:1;');
    ...
    if (config.title) {
        ...
        h2.setAttribute('style', 'position: absolute;color:white;font-size:21px;text-shadow: 1px 1px black;padding:0;margin:0;text-align: left; margin-top: 270px; margin-left: 10px; display: block; border: 0;line-height:1.5;z-index:1;');
